...
wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("#onGoing > div > div.mdl-grid.bg-skin2 > div > div.big-font2.font-base-regular.bold.ng-binding")));
String Orderno=driver.findElement(By.cssSelector("#onGoing > div > div.mdl-grid.bg-skin2 > div > div.big-font2.font-base-regular.bold.ng-binding")).getText();
