...
public class Configuration_ofs {
	public static WebDriver driver;
	public static FileInputStream fileinput,fileinput1,fileinput2,fileinput3=null;
	
	public static Properties obj=null;
		
		
		public void Ofs_launch() throws IOException
		{
			...
			fileinput=new FileInputStream("C:\\Users\\hp\\eclipse-workspace\\Flyrobe\\src\\S_Ofs\\login_input.txt");
			obj = new Properties();
			obj.load(fileinput);
			String username=obj.getProperty("Username");
			String pwd=obj.getProperty("Pass");
