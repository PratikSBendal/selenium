...
public class OMtab_ofs extends Multiple_status{
	public void feasign(String orderid,String feassign,String measured,String confrim) throws InterruptedException, IOException
	{
...
//		Thread.sleep(500);
		...
		//Select Status
		    BufferedReader statusread = new BufferedReader(new FileReader("C:\\Users\\hp\\eclipse-workspace\\Flyrobe\\src\\S_Ofs\\Status_Selection\\OM_tab_Reserver_Measusring_FE_assign_or_other_status.txt"));
			...
			if(switch1==0)
			{
				 int statusint=Integer.parseInt(feassign);
		    switch(statusint)
			{
		    case 1:
		    ...
		    case 4://positive flow
		       ...
		       driver.findElement(By.xpath("//div[@class='col-lg-5']/descendant::div[contains(@class,'ibox-content om-item')]/descendant::td[9]")).click();//drop-down list
		    	driver.findElement(By.xpath(".//option[contains(text(),normalize-space('Out For Measurement'))]")).click();//'Out For Measurement
		    	driver.findElement(By.xpath("//html//div[@class='col-lg-5']/div[@class='col-xs-6']/button[1]")).click();//click submit button
		    	Out_For_Measurnment_trasition(orderid,measured);//its select a transition after FE expert assign.
		    	Measurnmnet_trasition(orderid,confrim);//its select a transition after measured 
		    	break;
		    	default:
	...
	public void confrimorder(String orderid,String alt,String iqc,String pkd) throws InterruptedException, IOException
	{ 
		Actions action=new Actions(driver);
		fileinput3=new FileInputStream("C:\\Users\\hp\\eclipse-workspace\\Flyrobe\\src\\S_Ofs\\Flow\\Switch\\switch.txt");
	    obj = new Properties();
		...
		driver.findElement(By.cssSelector("div.ui-select-choices-row:nth-child(3) > a:nth-child(1) > div:nth-child(1)")).click();//select mumbai city
			...
			if(switch1==0)
			{
				 int statusint=Integer.parseInt(alt);
		    switch(statusint)
			{
	...
	public void om_logistic(String orderid,String dba,String dvd) throws IOException, InterruptedException
	{
...
//		Thread.sleep(5000);
		...
		driver.findElement(By.xpath("//*[@id=\"page-wrapper\"]/div[2]/div/div[2]/div[3]/div[6]/div[2]/div[3]/div[1]/div[4]/div/input[1]")).sendKeys("Pratik",Keys.ENTER);
		 driver.findElement(By.xpath("//div[@class='col-lg-5']/descendant::div[contains(@class,'ibox-content om-item')]/descendant::td[9]")).click();//dropdown list
			BufferedReader om_logistic = new BufferedReader(new FileReader("C:\\Users\\hp\\eclipse-workspace\\Flyrobe\\src\\S_Ofs\\Status_Selection\\OM_tab_Reserver_Measusring_after_package__or_other_status.txt"));
			Scanner console = new Scanner(System.in);
			String statusread1;
			...
			if(switch1==0)
			{
				 int statusint=Integer.parseInt(dba);
		    switch(statusint)
			{
			case 1:
		    	driver.findElement(By.xpath(".//option[contains(text(),normalize-space('Cancelled By Us'))]")).click();//Cancelled By Us
			...
			case 3:
				...
				driver.findElement(By.xpath("//html//div[@class='col-lg-5']/div[@class='col-xs-6']/button[1]")).click();
				after_delivery_boy_assign(orderid,dvd);
		    	break;
			case 4:
	...
	public void om_logistic_pickup(String orderid,String piup) throws InterruptedException, IOException
	{
		Actions action = new Actions(driver);
		fileinput3=new FileInputStream("C:\\Users\\hp\\eclipse-workspace\\Flyrobe\\src\\S_Ofs\\Flow\\Switch\\switch.txt");
	    obj = new Properties();
		obj.load(fileinput3);
		//String statusstring=obj.getProperty("CCtab");
		int switch1=Integer.parseInt(obj.getProperty("Manual"));
		WebElement moveonmenu = driver.findElement(By.xpath("//div[contains(@class,'sidebar-collapse')]/descendant::ul[contains(@id,'side-menu')]/child::li[3]"));
		action.moveToElement(moveonmenu).moveToElement(driver.findElement(By.xpath("//a[text()='Logistics']"))).click().perform();driver.manage().timeouts().implicitlyWait(500,TimeUnit.SECONDS);
		Thread.sleep(5000);
		...
		after_pickup_boy_assign(orderid,piup);//get status from out for pickup
		}	
